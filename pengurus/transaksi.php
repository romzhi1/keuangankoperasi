                      ...
                      <div class="form-group">
                        ...
                        <select name="bank" class="form-control" required="required">
                          ...
                          while($b = mysqli_fetch_array($bank)){
                            ?>
                            <option value="<?php echo $b['bank_id']; ?>"><?php echo $b['bank_pemilik']; ?></option>
                            <?php 
                          }
                          ?>
                        </select>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <select name="bank" class="form-control" required="required" style="width:100%">
                                      ...
                                      while($b = mysqli_fetch_array($bank)){
                                        ?>
                                        <option <?php if($d['transaksi_bank'] == $b['bank_id']){echo "selected='selected'";} ?> value="<?php echo $b['bank_id']; ?>"><?php echo $b['bank_pemilik']; ?></option>
                                        <?php 
                                      }
                                      ?>
                                    </select>
