              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="level" required="required">
                    ...
                    <option <?php if($d['user_level'] == "Pengurus"){echo "selected='selected'";} ?> value="Pengurus"> Pengurus </option>
                    <option <?php if($d['user_level'] == "Akuntansi"){echo "selected='selected'";} ?> value="Akuntansi"> Akuntansi </option>
                  </select>
                </div>
