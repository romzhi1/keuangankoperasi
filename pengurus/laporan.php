        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari']) && isset($_GET['kategori'])){
              ...
              <a href="laporan_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp MENCETAK</a>
              <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td class="text-center text-bold "><?php echo "Rp. ".number_format($total_pemasukan - $total_pengeluaran)." ,-"; ?></td>
                    </tr>

                    <?php
                        $saldo_bank = mysqli_query($koneksi,"SELECT * FROM bank");
                        while($bank = mysqli_fetch_array($saldo_bank)){
                  ?>

                      <th colspan="4" class="text-right">Saldo <?php echo $bank['bank_nama']; ?></th>
                      <td colspan="2" class="text-center text-bold text-white bg-primary"><?php echo "Rp. ".number_format($bank['bank_saldo'])." ,-"; ?></td>
